...
<style>
    ...
    .hero-pro {
        ...
        background: url('<?= BASE_URL ?>assets/images/canwinn-polyclinic-delhi-clinics-kccem392be.webp'); 
    ...
    .screenshot-content-section { padding: 30px 0; background: #fff; }
...
<main>
    <section class="hero-pro" data-aos="zoom-out">
        <div class="container">
            <h1 data-aos="fade-down">GEETA BHAWAN</h1>
            <p class="lead mb-4 fw-bold" data-aos="fade-up" data-aos-delay="400">Serving Humanity with Excellence and Compassion.</p>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-6" data-aos="fade-right">
                    <h2 class="display-5 fw-bold mb-4">Geeta Bhawan Polyclinic - <span class="text-primary">Canwinn</span></h2>
                    <p class="text-muted fs-5">Founded by Dr. D.P. Goyal in March 2019, the CanWinn Foundation is
                         committed to enhancing public awareness and providing valuable health education to empower
                          individuals in taking charge of their well-being. As part of our dedication to a healthier 
                          India, we proudly present the Geeta Bhawan Polyclinic in Sector 7, Gurugram.</p>
  ...
  <!-- Services -->
            ...
            <div class="row g-4">
                <div class="col-lg-6" data-aos="fade-right">
                    <div class="info-block-card" style="border-left: 6px solid var(--p);">
                        ...
                        <h3 class="fw-bold mb-2">CanWinn Foundation : <span style="color:var(--p)"> A Commitment to Public Health</span></h3>
                        <p class="text-muted" style="line-height: 1.8;">The CanWinn Foundation, led by Dr. D.P. Goyal, is at the forefront of initiatives that prioritize public health. With a vision of creating a positive impact on society, our foundation works tirelessly to bridge the gap between healthcare awareness and its implementation. Geeta Bhawan Polyclinic stands as a testament to this commitment, providing accessible and quality healthcare services to the residents of Gurugram.</p>
                    </div>
                </div>
                <div class="col-lg-6" data-aos="fade-left">
                    <div class="info-block-card" style="border-left: 6px solid var(--t);">
                        ...
                        <p class="text-muted" style="line-height: 1.8;">At Geeta Bhawan Polyclinic, we are driven by a profound mission – “Swasth Bharat (स्वस्थ भारत),” translating to “Healthy India.” We recognize the importance of proactive healthcare and believe that informed individuals contribute to building a healthier society. Through our services, we aim to address health challenges and empower our community to make informed decisions about their well-being.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="screenshot-content-section">
        <div class="container">
            <h2 class="fw-bold mb-3 text-center" data-aos="fade-up">Services Offered at Geeta Bhawan Polyclinic:</h2>
            <div class="row">
                <div class="col-lg-12" data-aos="fade-up">
                    <div class="detailed-service-item"><h5>Comprehensive Health Check-ups:</h5><p> Our clinic offers thorough health check-ups to identify potential issues early.</p></div>
                    <div class="detailed-service-item"><h5>Specialized Consultations:</h5><p> Skilled professionals provide specialized consultations across medical disciplines.</p></div>
                    <div class="detailed-service-item"><h5>Diagnostic Services:</h5><p> State-of-the-art facilities ensure accurate and timely diagnostics.</p></div>
                    <div class="detailed-service-item"><h5>Preventive Healthcare Programs:</h5><p> Programs aimed to educate and empower individuals for a healthier lifestyle.</p></div>
                    <div class="detailed-service-item"><h5>Community Health Initiatives:</h5><p> We actively engage in camps and awareness programs to reach a wider audience.</p></div>
                </div>
            </div>

            <div class="mt-2 pt-2 border-top">
                <h2 class="fw-bold mb-2 text-center" data-aos="fade-up">Why Choose Us?</h2>
                <div class="row g-4">
                    <div class="col-lg-4" data-aos="zoom-in">
                        <div class="expertise-card">
                            <div class="expertise-icon-box"><i class="fas fa-user-md"></i></div>
                            <div class="expertise-text"><h5>Expert Professionals</h5><p>Dedicated team committed to compassionate and personalized care.</p></div>
                        </div>
                    </div>
                    <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="100">
                        <div class="expertise-card">
                            <div class="expertise-icon-box"><i class="fas fa-hospital-alt"></i></div>
                            <div class="expertise-text"><h5>Modern Facilities</h5><p>Infrastructure and medical equipment ensuring highest standards.</p></div>
                        </div>
                    </div>
                    <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="200">
                        <div class="expertise-card">
                            <div class="expertise-icon-box"><i class="fas fa-users"></i></div>
                            <div class="expertise-text"><h5>Community-Centric</h5><p>Initiatives that extend beyond the clinic to serve our community.</p></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="aarogya-dham-container">
        ...
        <div class="aarogya-dham-content">
            ...
            <div class="map-container" data-aos="fade-up" data-aos-delay="100">
               <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3507.527174850399!2d77.0120955752825!3d28.46366637575745!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d19b15aee2a8f%3A0xf5c19d461c09b851!2sCanWinn%20Polyclinic%20-%20Geeta%20Bhawan!5e0!3m2!1sen!2sin!4v1777455416936!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>

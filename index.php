...
<?php include('includes/canwinn_seva.php'); ?>

<?php include('includes/reviews_testimonials_section.php'); ?>
<?php include('includes/partners_section.php'); ?>
<?php include('includes/sathi_cta.php'); ?>
